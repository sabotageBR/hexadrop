 ...
 * @property {{fill:string, stroke:string, glow:string}} pedestal
...
export const THEMES = {
  ...
  neon: {
    ...
    materials: {
      wood: { fill: 'rgba(255,196,60,0.14)', stroke: '#ffc43c', inner: 'rgba(255,196,60,0.5)' },
      stone: { fill: 'rgba(255,61,110,0.14)', stroke: '#ff3d6e', inner: 'rgba(255,61,110,0.5)' },
      ice: { fill: 'rgba(80,226,255,0.16)', stroke: '#50e2ff', inner: 'rgba(80,226,255,0.55)' },
      rubber: { fill: 'rgba(66,255,140,0.14)', stroke: '#42ff8c', inner: 'rgba(66,255,140,0.5)' },
      metal: { fill: 'rgba(178,198,255,0.14)', stroke: '#b2c6ff', inner: 'rgba(178,198,255,0.5)' },
      glass: { fill: 'rgba(210,245,255,0.1)', stroke: '#d2f5ff', inner: 'rgba(210,245,255,0.42)' },
      foam: { fill: 'rgba(255,140,220,0.14)', stroke: '#ff8cdc', inner: 'rgba(255,140,220,0.5)' },
      bomb: { fill: 'rgba(255,90,60,0.2)', stroke: '#ff5a3c', inner: 'rgba(255,200,60,0.75)' },
      obsidian: { fill: 'rgba(120,96,180,0.3)', stroke: '#8a74c8', inner: 'rgba(60,44,100,0.9)' },
    },
    pedestal: { fill: 'rgba(150,90,255,0.35)', stroke: '#b98cff', glow: '#a066ff' },
  ...
  futuristic: {
    ...
    pedestal: { fill: '#152a38', stroke: '#2ee6c4', glow: '#2ee6c4' },
  ...
  rustic: {
    ...
    pedestal: { fill: '#6b4a2f', stroke: '#3a2717', glow: '#e8b26a' },
  ...
  classic: {
    ...
    pedestal: { fill: '#7b8aa0', stroke: '#48556a', glow: '#2f6df0' },
  ...
  candy: {
    ...
    pedestal: { fill: '#b28ce8', stroke: '#6f4dad', glow: '#ff9ed4' },
  ...
  ice: {
    ...
    pedestal: { fill: '#2c5a75', stroke: '#9fe0f5', glow: '#9fe0f5' },
  ...
  lava: {
    ...
    pedestal: { fill: '#3b1b12', stroke: '#ff8a2a', glow: '#ff6a12' },
  ...
  paper: {
    ...
    pedestal: { fill: '#c0a880', stroke: '#7c6748', glow: '#d2603a' },
