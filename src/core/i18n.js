...
const STRINGS = {
  ...
  pt: {
    ...
    newHazard: 'Novo obstaculo',
    hazardSwing: 'Plataforma que balanca',
  ...
  es: {
    ...
    newHazard: 'Nuevo obstaculo',
    hazardSwing: 'Plataforma que se balancea',
    hintSwing: 'Calcula el momento de la caida.',
    hazardWind: 'Viento',
    hintWind: 'Las rafagas empujan todo de lado.',
